<template>
  <div class="container has-text-grey-lighter" style="margin-top: 55px" >
    <h1 class="title has-text-grey-lighter has-text-centered">Help About Coffee</h1>
    <p>
    ...
    <h1 class="title has-text-grey-lighter" align="center">Light Roast:</h1>
    <img src="../assets/images/lightR.png" height="45" width="45" class="center">
    ...
    <p>
      ...
      <br>
      <br>
      Light roasted beans generally reach an internal temperature of 356°F to 401°F. At or around 300-350 degrees, the beans pop or crack and expand in size. This is known as the first crack (for the second crack, see below). So a light roast generally means a coffee that has not been roasted beyond the first crack.
      <br>
      <br>
    ...
    <h1 class="title has-text-grey-lighter" align="center">Medium Roast:</h1>
    <img src="../assets/images/mediumR.png" height="45" width="45" class="center">
    <p>
    ...
    <h1 class="title has-text-grey-lighter" align="center" >Dark Roast:</h1>
    <img src="../assets/images/darkR.png" height="45" width="45" class="center">
    <p>
    ...
    <ul style="list-style-type:disc; margin: 25px " >
      <li>
